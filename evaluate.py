...
assert opt.data in ['camera_val', 'real_test']
if opt.data == 'camera_val':
    result_dir = opt.result_dir
    file_path = 'CAMERA/test_list.txt'
...
def detect():
    # resume model
    estimator = SPGANet(opt.n_cat, opt.nv_prior, num_structure_points=opt.num_structure_points)
    estimator.cuda()
